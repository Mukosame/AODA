...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--datarootA", type=str, help="path to images A")
        parser.add_argument("--datarootB", type=str, help="path to images B")
        parser.add_argument(
            "--name",
            type=str,
        ...
        parser.add_argument(
            "--nz", type=int, default=8, help="# of gen filters in first conv layer"
        )
        parser.add_argument(
            "--ngf",
            type=int,
        ...
        parser.add_argument(
            ...
            help="specify generator architecture [resnet_9blocks_c |resnet_9blocks | resnet_6blocks | unet_256 | unet_128]",
        )
        parser.add_argument(
            "--netGC",
            type=str,
            default="adaresnet_9blocks_c",
            help="specify generator architecture [resnet_9blocks_c | unet_256_c | adaresnet_9blocks_c]",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            type=int,
            default=0,
            help="the number of labels for the dataset",
        )
        parser.add_argument(
    ...
    def print_options(self, opt):
        ...
        if opt.phase == "train" and (not opt.resume_state):
            util.mkdir_and_rename(expr_dir)
