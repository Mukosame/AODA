# ------------------------------------------------------------------------------
# Original from: https://github.com/HRNet/HRNet-Image-Classification/blob/master/lib/models/cls_hrnet.py
...
class HighResolutionNet(nn.Module):
    def __init__(self, label_num):  # , cfg, **kwargs):
        ...
        self.classifier = nn.Linear(2048, label_num)
